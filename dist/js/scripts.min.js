...
$(document).ready(function () {
  ...
  var buttonBox = document.querySelectorAll('.metal__arrow-box');
  var upArrow = document.querySelectorAll('.metal__arrow-up');
  var downArrow = document.querySelectorAll('.metal__arrow-down');
  var listMetal = document.querySelectorAll('.metal__col');
  var currentMetal = 0;
  ...
  function showButtonSwitching() {
    var metalShadow = document.querySelector('.metal__right-shadow');

    if (document.body.clientWidth <= 360) {
      // buttonBox.classList.remove('hidden');
      buttonBox.forEach(function (el) {
        el.classList.remove('hidden');
      });
      listMetal.forEach(function (item, i) {
        if (i !== 0) {
      ...
      listMetal.forEach(function (item) {
  ...
  var metalContainer = document.querySelector('.metal');
  var metalRow = document.querySelector('.metal__row'); // metalRow
  ...
  function overflow() {
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent)) {
      ...
      metalRow.addEventListener('mousedown', function (e) {
        var pagex = e.pageX;
        var startX = metalRow.scrollLeft + pagex;
  ...
  function onWheel(e) {
    e = e; // wheelDelta не даёт возможность узнать количество пикселей

    var delta = e.deltaY || e.detail || e.wheelDelta;
    var modifier;

    if (e.deltaMode == e.DOM_DELTA_PIXEL) {
      modifier = 1; // иные режимы возможны в Firefox
